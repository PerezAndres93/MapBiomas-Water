...
var bands_l5 = ['B1', 'B2', 'B3', 'B4', 'B5', 'B7']; // edited by Jorge
var bands_l7 = ['B1', 'B2', 'B3', 'B4', 'B5', 'B7']; // edited by Jorge
var bands_l8 = ['B2', 'B3', 'B4', 'B5', 'B6', 'B7']; // edited by Jorge
...
grid_names.forEach(function(grid_name){
  ...
  PtosClass = ee.FeatureCollection('users/ingperezescobar/mapbiomas-raisg/PRODUCTOS/AGUA/GUIANAFRANCESA/DATOS_AUXILIARES/Ptos_'+grid_name+'-class2')
...
Export.table.toDrive({
  ...
  description:'Ptos-bg-gf-'+reductor+'-02-'+pais_name, 
  fileNamePrefix:'Ptos-gf-bol-'+reductor+'-02'+pais_name, 
  folder:'MapBiomas', 
  fileFormat:'CSV',
})
