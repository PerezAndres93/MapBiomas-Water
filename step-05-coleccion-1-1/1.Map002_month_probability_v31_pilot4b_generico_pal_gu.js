...
//Umbrales para la clasificación de Agua 
  Limeares:{
    ...
    shade_min :86, // Percentil 2 ; valor original es 80
    shade_max : 91, // Percentil 8
    gv_soil_min : 0, // Percentil 2
    gv_soil_max : 8, // si el P8 es 0, pasar al percentil 92
    cloud_desc_min : 20, // Percentil 92
    cloud_desc_max : 25, // Percentil 98
    cloud_asc_min : 1,// Percentil 2
    cloud_asc_max : 3,// Percentil 8
  },
  ...
  ApplySMAe:{
    ...
    shade  :[0.998,0.346],// m y b (y=mx+b): corregir con la ecuación de la pendiente
    gv_soil:[1,0.767],// m y b: corregir con la ecuación de la pendiente
    cloud  :[0.909,0.0309] // m y b: corregir con la ecuación de la pendiente
  ...
  cartasFechasVal:[
       ['NB-21-V',[[1993,1],[1993,8],[2007,2],[2009,5],[2014,1],[2015,4]]],   //g.Francesa SUL
       ['NB-21-Y',[[1998,9],[1999,11],[2011,1],[2011,8],[2017,10],[2017,5]]],  //g.Francesa NORTE
  ],
} 
