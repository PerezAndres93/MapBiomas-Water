...
var param = {
  ...
  ExportPiloto:'clasificacion-4b76', // Nombre del asset donde se guardará el piloto
  Comparacion:false, // si queremos visualizar la diferencia del piloto actual con un anterior piloto
  Validacion:false, // Si queremos imprimir la validación del piloto actual en base a puntos colectados
...
//Umbrales para la clasificación de Agua 
  Limeares:{
    ...
    shade_min : 76, // Percentil 2 ; valor original es 80
    shade_max : 90, // Percentil 8
    gv_soil_min : 0, // Percentil 2
    gv_soil_max : 7, // si el P8 es 0, pasar al percentil 92
    cloud_desc_min : 25, // Percentil 92
    cloud_desc_max : 35, // Percentil 98
    cloud_asc_min : 0,// Percentil 2
    cloud_asc_max : 5,// Percentil 8
  },
  ...
  cartasFechasVal:[
       ['NA-22-V',[[1988,7],[1989,8],[2003,8],[2004,12],[2017,7],[2018,9]]],   //g.Francesa SUL
       ['NB-22-Y',[[1989,8],[1990,7],[2003,8],[2004,11],[2017,9],[2019,11]]],  //g.Francesa NORTE
  ],
} 
...
if (param.Validacion){
  ...
  cartas.forEach(function(carta){
    ...
    PuntosClass = PuntosClass.merge(ee.FeatureCollection('projects/mapbiomas-raisg/PRODUCTOS/AGUA/'+Pais.toUpperCase()+'/DATOS_AUXILIARES/Ptos_'+carta+'-class'))
