...
var paisName = 'Guyana'; // Ecuador, Perú, Bolivia, Venezuela, Combia, Suriname, Guiana Francesa, Guyana
var paisName1 = 'Guyana'
var version = 1
var vis_month = 'w_1'
var region = 1 // 1 - Andes (por region)  -- 2 -Amazonia baja (por carta) 
var asset = 'users/ingperezescobar/mapbiomas-raisg/PRODUCTOS/AGUA/GUYANA/COLECCION1/clasificacion-4b'
...
var regAndesexport = regAndes.filter(ee.Filter.inList('id_region',[502,509]))
...
//var mosaicPais = 200
var tierrasBajas = (MaskAndes.eq(502).or(MaskAndes.eq(509))).selfMask()
...
var tableRegions = [
    ...
    // Region Amazonia baja o pasifico
...
for (var i=0; i< grid_names.length; i++) {
  // if (grid_names.length>i){
    ...
    var subgrids_grid = subgrids
      ...
      .filterBounds(pais); 
    //print("subgrids_grid",subgrids_grid)  
    var subg 
