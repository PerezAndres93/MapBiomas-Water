...
var paisName = 'GuianaFrancesa'; // Ecuador, Perú, Bolivia, Venezuela, Combia, Suriname, Guiana Francesa, Guyana
var paisName1 = 'Guiana Francesa'
var version = 1
var vis_month = 'w_1'
var region = 1 // 1 - Andes (por region)  -- 2 -Amazonia baja (por carta) 
var asset = 'users/ingperezescobar/mapbiomas-raisg/PRODUCTOS/AGUA/GUIANAFRANCESA/COLECCION1/clasificacion-4b'
...
// actualizar la ruta que se utilizara para la masccara de la region de andes
Map.addLayer(regAndes,{},"regAndes")

var regAndesexport = regAndes.filter(ee.Filter.inList('id_region',[602]))
