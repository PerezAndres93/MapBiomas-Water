var paisName = 'Guyana'; // Ecuador, Perú, Bolivia, Venezuela, Colombia, Suriname, Guiana Francesa, Guyana  
...
for (var i=28; i<38; i++) {
  ...
  Export.image.toAsset({
    ...
    assetId: 'users/ingperezescobar/mapbiomas-raisg/PRODUCTOS/AGUA/'+ namecountry.toUpperCase() +'/COLECCION1/POSTPROCESSING/021-pre-gap-03/' + 'water-gap-' + year, 
  ...
  Map.addLayer(img,imageVisParam1,'input ' + viz_month + ' '  + year, false)
